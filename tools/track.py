...
def make_parser():
    ...
    parser.add_argument("--conf", default=0.01, type=float, help="test conf")    # 0.01
    parser.add_argument("--nms", default=0.7, type=float, help="test nms threshold")
    parser.add_argument("--tsize", default=None, type=int, help="test img size")
    parser.add_argument("--seed", default=None, type=int, help="eval seed")
    # tracking args
    parser.add_argument("--track_thresh", type=float, default=0.5, help="tracking confidence threshold")  # 0.6
...
def main(exp, args, num_gpu):
    ...
    # start evaluate
    *_, summary = evaluator.gevaluate(
        model, is_distributed, args.fp16, trt_file, decoder, exp.test_size, results_folder
    )
    # newbyte  gevaluate 加g就是gbyte
    # *_, summary = evaluator.newevaluate(
    ...
    if args.mot20:
        ...
        # gtfiles = glob.glob(os.path.join('datasets/mot/train', '*/gt/gt{}.txt'.format(gt_type)))  visdrone/train', '*/gt/gt{}.txt'
        gtfiles = glob.glob(os.path.join('datasets/UAV/test', '*/gt/gt_whole.txt'.format(gt_type)))   #UAV test gt_whole
